...
#nullable enable
    ...
    private void RefreshCachedDevices(object sender, EventArgs e)
    {
        ...
        CachedDevices = rawDevices.Select(device => new Dictionary<Column, object>()
        {
            ...
            {Column.LastReportTime, (device.LastStatusReportTime as DateTime?)?.ToLocalTime() ?? DateTime.MinValue},
            {Column.EnrollmentTime, (device.EnrollmentTime as DateTime?)?.ToLocalTime() ?? DateTime.MinValue},
